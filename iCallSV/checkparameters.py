...
def checkFile(fileToCheck):
    if(os.path.isfile(fileToCheck)):
        ...
        logging.fatal("checkparameters:Given File: %s does not exists. Sorry please check this Input and Run Again.", %(fileToCheck))
        sys.exit()
...
def checkDir(folderToCheck):
    if(os.path.isdir(folderToCheck)):
        ...
        logging.fatal("checkparameters:Given Directory: %s does not exists. Sorry please check this Input and Run Again.",%(folderToCheck))
        sys.exit()
...
def checkInt(variableToCheck, variableName):
    if(isinstance(variableToCheck, int)):
        logging.info( "checkparameters: %s Variable: %d is an Integer.", %(variableName,variableToCheck))
    else:
        logging.fatal( "checkparameters: %s Variable: %d is not an Integer. Sorry please check this Input and Run Again.", %(variableName,variableToCheck))
        sys.exit()
...
def checkEmpty(variableToCheck, variableName):
    if(variableToCheck):
        ...
        logging.fatal( "checkparameters: %s Variable:%s is empty. Sorry please check this Input and Run Again.", %(variableName,variableToCheck))
        sys.exit()
...
def checkDellyAnalysisType(varaibleToCheck):
    if(varaibleToCheck == "DEL" or varaibleToCheck == "DUP" or varaibleToCheck == "INV" or varaibleToCheck == "TRA"):
        ...
        logging.fatal( "checkparameters:Given Delly Analysis Type: %s is not valid. Sorry please check this Input and Run Again.", %(varaibleToCheck))
        sys.exit()
